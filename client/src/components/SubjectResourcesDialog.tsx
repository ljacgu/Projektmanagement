          ...
          <ScrollArea className="h-[300px] pr-4 border rounded-md bg-secondary/10 p-4">
            {isLoading ? (
              ...
              <div className="space-y-3">
                {files.map((file) => (
                  <div key={file.id} className="flex items-center justify-between p-3 bg-card border rounded-lg hover:shadow-sm transition-shadow group" data-testid={`file-item-${file.id}`}>
